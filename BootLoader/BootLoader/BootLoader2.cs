...
*/
        ...
        private void UpGrade_Click(object sender, EventArgs e)
        {
            ...
            else                                    // 代码正确往下执行
            {
                ...
                {
                    if ((receivebytes[0] == 0xAA) && (receivebytes[3] == 0xCC) && (receivebytes[4] == 0x33) && (receivebytes[5] == 0xC3) && (receivebytes[6] == 0x3C))
                    {
                        if (receivebytes[1] == 0x00)        // 主程序返回握手
                        {
                            if (receivebytes[2] == 0x01)    // 应用程序握手成功
                            {
                                mainflag = 1;               // 处于应用程序里面
                        ...
                        else if (receivebytes[1] == 0x02)   // 升级程序返回
                        {
                            if (receivebytes[2] == 0x03)    // 升级程序握手成功
                            {
                ...
                if (mainflag == 1)  
                {
                    ...
                    {
                        if ((receivebytes[0] == 0xAA) && (receivebytes[1] == 0x02) && (receivebytes[3] == 0xCC) && (receivebytes[4] == 0x33) && (receivebytes[5] == 0xC3) && (receivebytes[6] == 0x3C))
                        {
                            switch (receivebytes[2])     // 判断哪个程序响应
                            {
                                case 0x01:  // 应用程序响应
                        ...
                        if ((receivebytes[0] == 0xAA) && (receivebytes[1] == 0x02) && (receivebytes[3] == 0xCC) && (receivebytes[4] == 0x33) && (receivebytes[5] == 0xC3) && (receivebytes[6] == 0x3C))
                        {
                            switch (receivebytes[2])     // 判断哪个程序响应
                            {
                                case 0x01:  // 如果主程序继续响应则表明跳转失败
                                    StatusBar.AppendText(DateTime.Now.ToString("HH:mm:ss  ") + "应用程序升级跳转失败\r\n");
                                    StatusBar.AppendText(DateTime.Now.ToString("HH:mm:ss  ") + "升级失败\r\n");
                                    return;
                                case 0x02:  // 应用程序反馈I2C异常
                                    StatusBar.AppendText(DateTime.Now.ToString("HH:mm:ss  ") + "应用程序升级跳转失败\r\n");
